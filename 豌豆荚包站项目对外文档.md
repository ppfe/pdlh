...
| downloadUrl     | (选填) 高速下载豌豆荚资源库没包时的下载链接 | String  | 无  |
...
### 3、checkPackageName 用来做什么？什么时机调用？
...
#### 4、checkPackageName、download、downloadFast 这些接口的第二个形参用来做什么？
...
#### 5、请求高度下载(downloadFast) 方法失败了会怎么样？
